...
Contributions are welcome. `go-ruby-grpc/grpc` is built to a small set of
...
The library is in [`github.com/go-ruby-grpc/grpc`](https://github.com/go-ruby-grpc/grpc).
This documentation site is in [`github.com/go-ruby-grpc/docs`](https://github.com/go-ruby-grpc/docs).
