...
The public API lives at the module root (`github.com/go-ruby-grpc/grpc`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `grpc`, while the surface follows
...
```go
import "github.com/go-ruby-grpc/grpc"
```
...
- **[pkg.go.dev/github.com/go-ruby-grpc/grpc](https://pkg.go.dev/github.com/go-ruby-grpc/grpc)**

The module's [README](https://github.com/go-ruby-grpc/grpc#readme) carries worked
