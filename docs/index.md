# go-ruby-grpc documentation

**Pure-Go (CGO=0), MRI-faithful reimplementation of Ruby's grpc gem — the GRPC object model for servers and stubs, without the gem's C extension.**

`go-ruby-grpc/grpc` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `grpc`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-grpc/grpc`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `grpc`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`grpc`](https://github.com/go-ruby-grpc/grpc) | the library — Ruby's `grpc` in pure Go |
| [`docs`](https://github.com/go-ruby-grpc/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-grpc.github.io`](https://github.com/go-ruby-grpc/go-ruby-grpc.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-grpc/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-grpc/grpc](https://github.com/go-ruby-grpc/grpc).
