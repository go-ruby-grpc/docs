...
`go-ruby-grpc/grpc` reimplements Ruby's `grpc` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-grpc/grpc` directly, with no Ruby runtime;
